...
242 AZMX-generated brand images, exported from the `Gradient & Bks` page of the New Direction Library Figma file. All are AI-generated by the AZMX design team (Midjourney and Seedream), so they are cleared for AZMX use with no third-party stock licensing.

Format: JPG, 1600 px wide, quality 70. Total 52 MB. Files are numbered per section, for example `assets/images/blue/blue-014.jpg`.
...
| Abstract Blue | `assets/images/blue/` | 113 | The core brand imagery set: abstract 3D forms, architecture, textures in navy and electric blue. Default choice for any AZMX surface needing an image. |
| Orange | `assets/images/orange/` | 28 | Categorical or client-specific work only. Not a brand color. |
| Purple | `assets/images/purple/` | 24 | Categorical or client-specific work only. Not a brand color. |
| Green | `assets/images/green/` | 11 | Categorical or client-specific work only. Not a brand color. |
| Yellow | `assets/images/yellow/` | 4 | Categorical or client-specific work only. Not a brand color. |
| Red | `assets/images/red/` | 23 | Categorical or client-specific work only. Not a brand color. |
...
2. Compare against what is already in `assets/images/<section>/` so existing images are not duplicated. Section counts at last export: gradient 34, blue 113, orange 28, purple 24, green 11, yellow 4, red 23, white 5.
